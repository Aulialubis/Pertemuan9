...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.dataTables.net/2.1.8/css/dataTables.dataTables.css" /><script src="https://code.jquery.com/jquery-3.7.1.js"></script>
<scriptsrc="https://code.jquery.com/jquery-3.7.1.js"integrity="sha256-eKhayi8LEQwp4NKxN+CfCh+3qOVUtJn3QNZ0TciWLP4="crossorigin="anonymous"></script>
  </head>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary shadow-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="?modul=home"><i class="bi bi-house-door"></i> Home</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="bi bi-person-circle"></i> Kusma Aulia Lubis </a>
                    <ul class="dropdown-menu">
